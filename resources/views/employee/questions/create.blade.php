                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" id="divA">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="optionA" class="form-control @error('optionA') is-invalid @enderror" placeholder="Enter Choose A" name="optionA" value="{{old('optionA')}}">
                                    @error('optionA')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-sm-6" id="divB">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="optionB" class="form-control @error('optionB') is-invalid @enderror" placeholder="Enter Choose B" name="optionB" value="{{old('optionB')}}">
                                ...
                                <div class="row">
                                    <div class="col-sm-6" style="display: inherit">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="customRadio1" name="right_answer" value="optionA" @if(old('right_answer')=='optionA' ) checked @endif>
                                            <label for="customRadio1" class="custom-control-label">صح</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="customRadio2" name="right_answer" value="optionB" @if(old('right_answer')=='optionB' ) checked @endif>
