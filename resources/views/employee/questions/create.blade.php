                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select @error('type') is-invalid @enderror" name="type"
                                                id="type">
                                            <option value="1"
                                                    @if(old('type') == 1) SELECTED @endif>True or
                                                False
                                            </option>
                                            <option value="2"
                                                    @if(old('type') == 2) SELECTED @endif>Multiple
                                                Chooses
                                            </option>
                                        </select>
                                        @error('type')
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="right_answer" id="answer"
                                            ...
                                            <option value="optionA">Choose A</option>
                                            <option value="optionB">Choose B</option>
                                            <option value="optionC">Choose C</option>
                                            <option value="optionD">Choose D</option>
                                        </select>
                                        @error('right_answer')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
