                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select @error('category') is-invalid @enderror"
                                                name="category">
                                            <option value="3"
                                                    @if(old('category', $question->category) == "3") SELECTED @endif>صعب
                                            </option>
                                            <option value="2"
                                                    @if(old('category', $question->category) == "2") SELECTED @endif>
                                                متوسط
                                            </option>
                                            <option value="1"
                                                    @if(old('category', $question->category) == "1") SELECTED @endif>سهل
                                            </option>
                                        </select>
                                        @error('category')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-sm-6" id="divA">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="optionA"
                                               ...
                                               placeholder="ادخل الاجابة أ" name="optionA"
                                ...
                                <div class="col-sm-6" id="divB">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="optionB"
                                               ...
                                               placeholder="ادخل الاجابة ب" name="optionB"
                                ...
                                <div class="col-sm-6" id="divC">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="optionD"
                                               ...
                                               placeholder="ادخل الاجابة ج" name="optionC"
                                ...
                                <div class="col-sm-6" id="divD">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="optionD"
                                               ...
                                               placeholder="ادخل الاجابة د" name="optionD"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="right_answer" id="answer"
                                            ...
                                            <option value="optionA"
                                                    @if(old('right_answer', $question->right_answer) == "optionA") SELECTED @endif>
                                                الخيار أ
                                            </option>
                                            <option value="optionB"
                                                    @if(old('right_answer', $question->right_answer) == "optionB") SELECTED @endif>
                                                الخيار ب
                                            </option>
                                            <option value="optionC"
                                                    @if(old('right_answer', $question->right_answer) == "optionC") SELECTED @endif>
                                                الخيار ج
                                            </option>
                                            <option value="optionD"
                                                    @if(old('right_answer', $question->right_answer) == "optionD") SELECTED @endif>
                                                الخيار د
                                            </option>
                                        </select>
                                        @error('right_answer')
                                    ...
                                    <div class="col-sm-6" style="display: inherit">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="customRadio1"
                                                   ...
                                                   @if(old('right_answer', $question->right_answer) == 'optionA') checked @endif>
                                            <label for="customRadio1" class="custom-control-label">صح</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="customRadio2"
                                                   name="right_answer" value="optionB"
                                                   @if(old('right_answer', $question->right_answer) == 'optionB') checked @endif>
