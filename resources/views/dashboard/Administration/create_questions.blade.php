                ...
                <form>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Choose A">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Choose B</label>
                            <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Choose B">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Choose C</label>
                            <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Choose C">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Choose D</label>
                            <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Choose D">
                        </div>
                        <div class="form-group">
                            <div class="col-sm-6">
                                <!-- select -->
