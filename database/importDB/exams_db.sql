...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2021 at 11:09 AM
...
(1, 1, 15, '2021-10-12', '22:00:00', '22:05:00', '2021-12-01', '09:00:00', '10:00:00', 4, NULL, NULL),
(2, 1, 12, '2021-09-09', '11:08:00', '11:50:00', '2021-12-01', '09:00:00', '10:00:00', 4, NULL, NULL),
...
(48, 'ERSS4214', 'التنظيم والإدارة في التربية الخاصة', 'Organization & employee in Special ED', '1', 4, 2, 2, 2, 1, 1, 3, NULL, NULL, NULL),
...
(1, 'khalid', 'عماد', 'إياد', 'علي', 'أبوسلمية', 'a@a.com', '0', 1, '$2y$10$9dS.fUKkCDprSrY0PkFYWOa6jTSb/CY8qPLYJGo2Ip0okDIXK2Xve', NULL, '2021-08-25 06:32:48', '2021-08-25 06:32:48'),
(2, 'khalid2', 'khalid', 'k', 'manuaruwe', 'ASDASD', 'a2@a.com', '0', 1, '$2y$10$9dS.fUKkCDprSrY0PkFYWOa6jTSb/CY8qPLYJGo2Ip0okDIXK2Xve', NULL, '2021-08-25 06:32:48', '2021-08-25 06:32:48'),
(3, 'khalid3', 'khalid', 'k', 'manuaruwe', 'ASDASD', 'a3@a.com', '0', 1, '$2y$10$9dS.fUKkCDprSrY0PkFYWOa6jTSb/CY8qPLYJGo2Ip0okDIXK2Xve', NULL, '2021-08-25 06:32:48', '2021-08-25 06:32:48');
...
CREATE TABLE `exams` (
  ...
  `number_of_questions` int(11) NOT NULL DEFAULT 10,
  ...
  `q_p_p` int(11) DEFAULT NULL COMMENT 'number of questions in page',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `exams` (`id`, `course_id`, `number_of_questions`, `back`, `type`, `review`, `value`, `show_result`, `q_p_p`, `created_at`, `updated_at`) VALUES
(31, 15, 0, 0, 'mid', 0, '0', NULL, NULL, '2021-09-12 08:36:54', '2021-09-12 08:36:54'),
(32, 15, 0, 0, 'final', 0, '0', NULL, NULL, '2021-09-12 08:36:54', '2021-09-12 08:36:54'),
(33, 12, 20, 0, 'mid', 0, '20', 0, NULL, '2021-09-12 08:36:54', '2021-09-12 08:37:13'),
(34, 12, 0, 0, 'final', 0, '0', NULL, NULL, '2021-09-12 08:36:54', '2021-09-12 08:36:54'),
(35, 5, 0, 0, 'mid', 0, '0', NULL, NULL, '2021-09-12 08:36:54', '2021-09-12 08:36:54'),
(36, 5, 0, 0, 'final', 0, '0', NULL, NULL, '2021-09-12 08:36:54', '2021-09-12 08:36:54'),
(37, 8, 0, 0, 'mid', 0, '0', NULL, NULL, '2021-09-12 08:36:54', '2021-09-12 08:36:54'),
(38, 8, 0, 0, 'final', 0, '0', NULL, NULL, '2021-09-12 08:36:54', '2021-09-12 08:36:54'),
(39, 7, 0, 0, 'mid', 0, '0', NULL, NULL, '2021-09-12 08:36:55', '2021-09-12 08:36:55'),
(40, 7, 0, 0, 'final', 0, '0', NULL, NULL, '2021-09-12 08:36:55', '2021-09-12 08:36:55'),
(41, 12, 55, 0, 'mid', 0, '55', 0, NULL, '2021-09-12 08:37:41', '2021-09-12 08:37:41');
...
CREATE TABLE `exam_results` (
  ...
  `result_exam` double DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 2020063, 2, '1', 12, 1, 7, NULL, NULL, NULL, '1', '1', NULL, '2021-09-10 22:14:26'),
...
(20, '2021_08_25_094248_create_exams_table', 2),
(21, '2021_08_25_094315_create_questions_table', 2),
(22, '2021_08_25_094435_create_exam_results_table', 2),
(23, '2021_08_25_191933_create_student_question_exams_table', 2);
...
CREATE TABLE `questions` (
  ...
  `optionC` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `optionD` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `right_answer` enum('optionA','optionB','optionC','optionD') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'optionA',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `questions` (`id`, `exam_id`, `type`, `title`, `category`, `optionA`, `optionB`, `optionC`, `optionD`, `right_answer`, `created_at`, `updated_at`) VALUES
(1, 13, '1', '<p>How are you?</p>', '2', 'صح', 'خطأ', '', '', 'optionA', '2021-09-08 16:43:55', '2021-09-08 17:18:36'),
(2, 13, '2', '<p>what is your name?</p>', '3', 'ali', 'bilal', 'ahmed', 'mohammed', 'optionB', '2021-09-08 16:43:55', '2021-09-08 17:21:32'),
(3, 13, '2', '<p>How old are You?</p>', '3', '22', '33', '55', '44', 'optionC', '2021-09-08 16:43:55', '2021-09-08 17:21:04'),
(4, 13, '1', '<p>Are you girl?</p>', '3', 'صح', 'خطأ', '', '', 'optionB', '2021-09-08 16:43:55', '2021-09-08 17:18:48'),
(5, 13, '1', '<p>Are you boy?</p>', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-08 16:43:55', '2021-09-08 17:18:55'),
(6, 13, '1', '<p>How are you?</p>', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-08 16:43:55', '2021-09-08 17:19:32'),
(7, 13, '2', '<p>what is your name?</p>', '3', 'Ahmed', 'Emad', 'shimaa', 'Khalid', 'optionB', '2021-09-08 16:43:55', '2021-09-08 17:20:46'),
(8, 13, '2', '<p>How old are You?</p>', '3', '20', '21', '25', '30', 'optionB', '2021-09-08 16:43:55', '2021-09-08 17:20:00'),
(9, 13, '1', '<p>Are you girl?</p>', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-08 16:43:55', '2021-09-08 17:19:09'),
(10, 13, '1', '<p>Are you boy?</p>', '3', 'صح', 'خطأ', '', '', 'optionB', '2021-09-08 16:43:55', '2021-09-08 17:19:18'),
(11, 13, '2', '<p>AAAAAAAAAAAAAAAAAAAA</p>', 'Hard', 'AAA', 'AAAA', 'AAAAA', 'AAAAAA', 'optionC', '2021-09-08 17:22:06', '2021-09-08 17:22:06'),
(12, 23, '1', 'عماد طالب مجتهد؟', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:04:45', '2021-09-10 22:04:45'),
(13, 23, '2', 'ما هو اسم المعلم؟', '3', 'احمد', 'عماد', 'خالد', 'شيماء', 'optionB', '2021-09-10 22:04:46', '2021-09-10 22:04:46'),
(14, 23, '2', 'ما هو اسم المعلم؟', '3', 'محمد', 'علي', 'اياد', 'بلال', 'optionC', '2021-09-10 22:04:46', '2021-09-10 22:04:46'),
(15, 23, '2', 'ما هو اسم المعلم؟', '3', 'عرفات', 'عبد الرحمن', 'صهيب', 'ناصر', 'optionA', '2021-09-10 22:04:46', '2021-09-10 22:04:46'),
(16, 23, '2', 'ما هو اسم المعلم؟', '1', 'حسن', 'بشار ', 'رائد', 'ادهم', 'optionA', '2021-09-10 22:04:46', '2021-09-10 22:04:46'),
(17, 23, '2', 'ما هو اسم المعلم؟', '1', 'مصعب', 'هيثم', 'خليل', 'حسام', 'optionB', '2021-09-10 22:04:46', '2021-09-10 22:04:46'),
(18, 23, '2', 'ما هو اسم المعلم؟', '1', 'مصعب', 'هيثم', 'خليل', 'حسام', 'optionA', '2021-09-10 22:04:46', '2021-09-10 22:04:46'),
(19, 23, '2', 'ما هو اسم المعلم؟', '3', 'أسامة', 'احمد ', 'إبراهيم', 'هدى', 'optionD', '2021-09-10 22:04:46', '2021-09-10 22:04:46'),
(20, 23, '2', 'ما هو اسم المعلم؟', '1', 'ايمان', 'هبة', 'اية', 'خلود', 'optionB', '2021-09-10 22:04:46', '2021-09-10 22:04:46'),
(21, 23, '1', 'عماد طالب مجتهد؟', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:05:42', '2021-09-10 22:05:42'),
(22, 23, '2', 'ما هو اسم المعلم؟', '3', 'احمد', 'عماد', 'خالد', 'شيماء', 'optionB', '2021-09-10 22:05:42', '2021-09-10 22:05:42'),
(23, 23, '2', 'ما هو اسم المعلم؟', '3', 'محمد', 'علي', 'اياد', 'بلال', 'optionC', '2021-09-10 22:05:42', '2021-09-10 22:05:42'),
(24, 23, '2', 'ما هو اسم المعلم؟', '3', 'عرفات', 'عبد الرحمن', 'صهيب', 'ناصر', 'optionA', '2021-09-10 22:05:42', '2021-09-10 22:05:42'),
(25, 23, '2', 'ما هو اسم المعلم؟', '1', 'حسن', 'بشار ', 'رائد', 'ادهم', 'optionA', '2021-09-10 22:05:42', '2021-09-10 22:05:42'),
(26, 23, '2', 'ما هو اسم المعلم؟', '1', 'مصعب', 'هيثم', 'خليل', 'حسام', 'optionB', '2021-09-10 22:05:42', '2021-09-10 22:05:42'),
(27, 23, '2', 'ما هو اسم المعلم؟', '1', 'مصعب', 'هيثم', 'خليل', 'حسام', 'optionA', '2021-09-10 22:05:42', '2021-09-10 22:05:42'),
(28, 23, '2', 'ما هو اسم المعلم؟', '3', 'أسامة', 'احمد ', 'إبراهيم', 'هدى', 'optionD', '2021-09-10 22:05:42', '2021-09-10 22:05:42'),
(29, 23, '2', 'ما هو اسم المعلم؟', '1', 'ايمان', 'هبة', 'اية', 'خلود', 'optionB', '2021-09-10 22:05:42', '2021-09-10 22:05:42'),
(30, 23, '1', 'عماد طالب مجتهد؟', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:06:02', '2021-09-10 22:06:02'),
(31, 23, '2', 'ما هو اسم المعلم؟', '3', 'احمد', 'عماد', 'خالد', 'شيماء', 'optionB', '2021-09-10 22:06:02', '2021-09-10 22:06:02'),
(32, 23, '2', 'ما هو اسم المعلم؟', '3', 'محمد', 'علي', 'اياد', 'بلال', 'optionC', '2021-09-10 22:06:02', '2021-09-10 22:06:02'),
(33, 23, '2', 'ما هو اسم المعلم؟', '3', 'عرفات', 'عبد الرحمن', 'صهيب', 'ناصر', 'optionA', '2021-09-10 22:06:02', '2021-09-10 22:06:02'),
(34, 23, '2', 'ما هو اسم المعلم؟', '1', 'حسن', 'بشار ', 'رائد', 'ادهم', 'optionA', '2021-09-10 22:06:02', '2021-09-10 22:06:02'),
(35, 23, '2', 'ما هو اسم المعلم؟', '1', 'مصعب', 'هيثم', 'خليل', 'حسام', 'optionB', '2021-09-10 22:06:02', '2021-09-10 22:06:02'),
(36, 23, '2', 'ما هو اسم المعلم؟', '1', 'مصعب', 'هيثم', 'خليل', 'حسام', 'optionA', '2021-09-10 22:06:02', '2021-09-10 22:06:02'),
(37, 23, '2', 'ما هو اسم المعلم؟', '3', 'أسامة', 'احمد ', 'إبراهيم', 'هدى', 'optionD', '2021-09-10 22:06:02', '2021-09-10 22:06:02'),
(38, 23, '2', 'ما هو اسم المعلم؟', '1', 'ايمان', 'هبة', 'اية', 'خلود', 'optionB', '2021-09-10 22:06:02', '2021-09-10 22:06:02'),
(39, 23, '1', 'aaa', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:22:37', '2021-09-10 22:22:37'),
(40, 23, '1', 'aaa', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:22:37', '2021-09-10 22:22:37'),
(41, 23, '1', 'aaa', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:22:37', '2021-09-10 22:22:37'),
(42, 23, '1', 'aaa', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:22:37', '2021-09-10 22:22:37'),
(43, 23, '1', 'aaa', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:22:37', '2021-09-10 22:22:37'),
(44, 23, '1', 'aaa', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:22:37', '2021-09-10 22:22:37'),
(45, 23, '1', 'aaa', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:22:37', '2021-09-10 22:22:37'),
(46, 23, '1', 'aaa', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:22:37', '2021-09-10 22:22:37'),
(47, 23, '1', 'aaa', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:22:37', '2021-09-10 22:22:37'),
(48, 23, '1', 'aaa', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:22:37', '2021-09-10 22:22:37'),
(49, 23, '1', 'aaa', '3', 'صح', 'خطأ', '', '', 'optionA', '2021-09-10 22:22:37', '2021-09-10 22:22:37'),
(50, 33, '2', 'How are you?', '0', 'aaa', 'aaaa', 'aaaaa', 'aaaa', 'optionB', '2021-09-12 08:43:16', '2021-09-12 08:43:16'),
(51, 33, '2', 'what is your name?', '0', 'aaa', 'aaaa', 'aaaaa', 'aaaa', 'optionB', '2021-09-12 08:43:17', '2021-09-12 08:43:17'),
(52, 33, '2', 'How old are You?', '0', 'aaa', 'aaaa', 'aaaaa', 'aaaa', 'optionC', '2021-09-12 08:43:17', '2021-09-12 08:43:17'),
(53, 33, '1', 'Are you girl?', '0', 'صح', 'خطأ', '', '', 'optionA', '2021-09-12 08:43:17', '2021-09-12 08:43:17'),
(54, 33, '1', 'Are you boy?', '0', 'صح', 'خطأ', '', '', 'optionA', '2021-09-12 08:43:17', '2021-09-12 08:43:17'),
(55, 33, '2', 'How are you?', '0', 'aaa', 'aaaa', 'aaaaa', 'aaaa', 'optionA', '2021-09-12 08:43:17', '2021-09-12 08:43:17'),
(56, 33, '2', 'what is your name?', '0', 'aaa', 'aaaa', 'aaaaa', 'aaaa', 'optionB', '2021-09-12 08:43:17', '2021-09-12 08:43:17'),
(57, 33, '2', 'How old are You?', '0', 'aaa', 'aaaa', 'aaaaa', 'aaaa', 'optionC', '2021-09-12 08:43:17', '2021-09-12 08:43:17'),
(58, 33, '1', 'Are you girl?', '0', 'صح', 'خطأ', '', '', 'optionA', '2021-09-12 08:43:17', '2021-09-12 08:43:17'),
(59, 33, '1', 'Are you boy?', '0', 'صح', 'خطأ', '', '', 'optionA', '2021-09-12 08:43:17', '2021-09-12 08:43:17');
...
(2, 2, 1, 1, 110, '10:00:00', '11:00:00', 'su', '0', '1', NULL, NULL),
...
(2015007, 2015007, 'فداء ', 'محمد', 'جمعة', 'أبو طعيمة', 86.1, 'fadosh.179@gmail.com', '$2y$10$9dS.fUKkCDprSrY0PkFYWOa6jTSb/CY8qPLYJGo2Ip0okDIXK2Xve', 1, 'zlnNAMpwFjrtjfaZCH7iYRXP6sjam8RJhgLeETnqqghVEatSFqMjiK1opRFP', NULL, '2017-06-06 15:34:50'),
...
(2020063, 2020063, 'يوسف', 'عبد الرحمن', 'يوسف', 'زينو', 67.6, 'yousef29121988@gmail.com', '$2y$10$9dS.fUKkCDprSrY0PkFYWOa6jTSb/CY8qPLYJGo2Ip0okDIXK2Xve', 1, 'CBiIDibNA7kLygm546Fr0i3o4bkZXcv6KeY9ESS24uUAjE8HFvVPB6tvy2wZ', '2021-02-28 10:57:56', '2021-03-14 11:06:32'),
...
--
-- Table structure for table `student_question_exams`
--

CREATE TABLE `student_question_exams` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `question_id` bigint(20) UNSIGNED DEFAULT NULL,
  `student_id` bigint(20) UNSIGNED DEFAULT NULL,
  `exam_id` bigint(20) UNSIGNED DEFAULT NULL,
  `answer` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'when std don''nt answer question insert char z',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `student_question_exams`
--
ALTER TABLE `student_question_exams`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `student_question_exams`
--
ALTER TABLE `student_question_exams`
